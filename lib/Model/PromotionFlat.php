 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PromotionFlat implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'promotion_flat';
...
'individual_codes' => 'getIndividualCodes'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['max_redemptions_global'] === null) {
            $invalidProperties[] = "'max_redemptions_global' can't be null";
        }
        if ($this->container['max_redemptions_per_customer'] === null) {
            $invalidProperties[] = "'max_redemptions_per_customer' can't be null";
        }
